            ...
            <div key={i} className={`flex gap-2.5 animate-fade-up ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
              ...
              {msg.role === 'user' ? (
                <div className="w-8 h-8 rounded-lg shrink-0 flex items-center justify-center text-xs font-bold"
                  style={{ background: 'rgba(11,110,79,0.12)', border: '1px solid rgba(11,110,79,0.28)', color: 'var(--gold-lo)' }}>
                  You
                </div>
              ) : (
                  ...
                  <div className={`px-4 py-3 text-[13px] leading-[1.75] ${
                    ...
                    {msg.attachmentName && (
                      <div className="flex items-center gap-1.5 mb-2 px-2 py-1 rounded-md text-[11px] font-semibold w-fit"
                        style={{ background: 'rgba(11,110,79,0.10)', border: '1px solid rgba(11,110,79,0.22)', color: 'var(--gold-lo)' }}>
          ...
          <div className="px-5 pt-1 relative z-[1] animate-fade-up">
            {attachError ? (
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11.5px] font-semibold"
                style={{ background: 'rgba(11,110,79,0.08)', border: '1px solid rgba(11,110,79,0.25)', color: 'var(--gold-lo)' }}>
        ...
        <div className="px-5 pb-4 pt-2 relative z-[1]">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-xl border border-[rgba(15,23,42,0.10)] transition-all focus-within:border-[var(--gold-hi)] focus-within:shadow-[0_0_0_3px_rgba(11,110,79,0.10)]"
            ...
            <button onClick={() => send()}
              ...
              style={{ background: 'var(--gold-grad)', boxShadow: '0 3px 12px rgba(11,110,79,0.30)' }}>
