 ...
 * dependency-free SVG chart, themed to match the NCGR RAM UI. Supports bar, line,
...
// NCGR-themed categorical palette (mirrors src/index.css tokens).
const PALETTE = ['#0b6e4f', '#0e7490', '#b45309', '#047857', '#084c37',
                 '#475569', '#12925f', '#0891b2', '#92400e', '#1e293b'];
