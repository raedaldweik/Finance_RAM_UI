    ...
    <header className="app-header">
      ...
      <div className="title-block">
        <div className="title-row">
          <h1 className="app-title">NCGR Retrieval Agent Assistant</h1>
            ...
            {signin.kind === 'code' ? (
              <>
                ...
                <div className="flex gap-2">
                  <input value={viyaCode} onChange={e => setViyaCode(e.target.value)}
                    ...
                    style={{ background: 'rgba(255,255,255,0.7)', borderColor: 'rgba(11,110,79,0.35)', color: 'var(--text)' }} />
              ...
              <>
                ...
                <div className="rounded-xl py-4 text-center mb-4"
                  style={{ background: 'rgba(11,110,79,0.07)', border: '1px dashed rgba(11,110,79,0.35)' }}>
